...
export class ExperienceFormComponent implements OnInit {
    ...
    initForm() {
        this.form = this.fb.group({
            ...
            dateStarted: this.fb.control('', Validators.required),
            dateEnded: this.fb.control('', Validators.required),
        });
    }
    ...
    onFormSubmit() {
        ...
        data.dateStarted = new Date(data.dateStarted).getTime();
        data.dateEnded = new Date(data.dateEnded).getTime();
