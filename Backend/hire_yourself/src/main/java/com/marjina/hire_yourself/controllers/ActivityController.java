...
public class ActivityController {
    ...
    @PutMapping(value = "/update/{activityId}", produces = APPLICATION_JSON_VALUE)
    ...
    public ResponseEntity<ResponseDTO> getListOfActivity() throws NotFoundException {
        return ResponseEntity.ok(new ResponseDTO<>(SUCCESS, service.getActivityList(), "Successful activity delete", emptyList()));
    }
